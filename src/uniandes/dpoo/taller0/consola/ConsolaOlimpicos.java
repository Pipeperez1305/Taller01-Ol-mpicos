...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa un atleta consultado");
	...
	/**
	 * Le pide al usuario el nombre de un atleta y luego le muestra el país al cuál pertenece el deportista.
	 */
	private void ejecutarEncontrarPaisAtleta()
	{
		System.out.println("\n" + "País al que pertenece un Atleta" + "\n");

		String nom_atleta = input("Por favor ingrese el nombre del Atleta");
		String pais_atleta = calculadora.paisPorAtleta(nom_atleta);
		if (pais_atleta == null)
		{
			System.out.println("No se encontró un atleta llamado " + nom_atleta);
		}
		else
		{
			System.out.println(" El atleta " + nom_atleta + " representa al país de " + " --> " + pais_atleta);
		}
	}
